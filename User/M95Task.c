...
void ThreadM95Task(void const * argument)
{
	...
	*/
	...
	fm25v02_write( 2*(0x28C0+((12-1)*31)+9-1+0), 0x00 );
	fm25v02_write( 2*(0x28C0+((12-1)*31)+9-1+0)+1, 17 );
	fm25v02_write( 2*(0x28C0+((12-1)*31)+9-1+1), 0x00 );
	fm25v02_write( 2*(0x28C0+((12-1)*31)+9-1+1)+1, 29 );

	fm25v02_write( 2*(0x28C0+((12-1)*31)+9-1+8), 0x00 );
	fm25v02_write( 2*(0x28C0+((12-1)*31)+9-1+8)+1, 17 );
	fm25v02_write( 2*(0x28C0+((12-1)*31)+9-1+9), 0x00 );
	fm25v02_write( 2*(0x28C0+((12-1)*31)+9-1+9)+1, 31 );
