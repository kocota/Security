...
#define SECURITY_REG                     0x1001 // (4097) статус режима охраны (0 - резерв ;1- включена из центра; 2 - отключена из центра; 3 - включена таблеткой 4 - отключена таблеткой; 5 - тревога открытия двери; 6 - процесс постановки на охрану; 7 - не удаётся поставить на охрану; )
